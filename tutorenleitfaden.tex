...
\begin{itemize}
	...
	\begin{tikzpicture}
		...
		\node (u2) [ellipse,draw] at (7.2,-2.7) {\"Ubung};
		\node (v3) [ellipse,draw] at (10.1,-1.6) {Vorlesung};
		\node (u3) [ellipse,draw] at (10.7,-2.7) {\"Ubung};
		\draw (5,-3.3) -- (12,-3.3);
		\node (p2) [ellipse,draw] at (7.4,-3.85) {Nikolauspr\"ufung};
		\node (p3) [ellipse,draw] at (10.5,-4.4) {Pr\"ufung};
	\end{tikzpicture}
