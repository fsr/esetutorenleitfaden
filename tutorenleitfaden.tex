...
\item ab 12:30 Mittagspause
  ...
  \begin{itemize*}
    ...
    \item E-Meal aufladen erklären! Automaten, Infopoint, Autoload, an der Kasse (Zeitersparnis)
...
\item Wanderung
  \small{\textit{
  \begin{itemize*}
	\item Treff um 8:15 Uhr Gleis 18 am Hauptbahnhof Dresden
...
\item 09:00 - 11:00 Seminargruppentreffen und parallele Vorträge
\item 11:00 - 13:00 Seminargruppentreffen und parallele Vorträge
\small{\textit{
	\begin{itemize*}
		\item Es gibt zwei verschiedene Termine.
		\item Zeitraum ist abhängig von der Seminargruppe
	\end{itemize*}
}}
...
\begin{itemize*}
    ...
    \item Alle wichtigen Infos: Prüfungs- und Studienordnung sowie Studienablaufplan und Modulbeschreibungen findet ihr auf der ESE-Webseite unter "Rund ums Studium" - außerdem gibt es ein gedrucktes Exemplar im ersten Seminargruppentreffen
