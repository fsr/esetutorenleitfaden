...
\item Am ESE-Montag bitte spätestens um 9:00 da sein und mit helfen!
...
\begin{itemize*}
	...
	\item Studiendekan: Prof. Weber (allgemein), Prof. Friedrich (Lehramtsstudiengänge), Prof. Hölldobler (englischsprachige Studiengänge). TODO: Fakten.
...
\begin{itemize}
  ...
  \item \textbf{Deshalb wichtig!} Falls noch nicht geschehen: Passwort noch heute im IDM ändern, damit morgen die Einschreibung funktioniert: https://idm-service.tu-dresden.de -- ruhig als Hausaufgabe aufgeben. TODO: Fakten. Tokens.
